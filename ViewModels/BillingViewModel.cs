...
namespace GroceryPOS.ViewModels
{
    ...
    public class BillingViewModel : BaseViewModel
    {
        ...
        public BillingViewModel(AuthService authService, ItemService itemService, BillService billService, PrintService printService, IStockService stockService)
        {
            ...
            _stockService.StockChanged += LoadItems;
